...
const SEARCHES = [
  'where should i buy directv',
  'why does my eye twitch',
  'why is my toe green',
  'why do i feel so stupid',
  'why do i always feel happy',
  'why do i always have a butt',
  'why does my leg itch',
  'why does my laptop trackpad smell',
  'why does my dog attacks cats',
  'why does my dog eat its tail',
  'why does my keyboard smell so bad',
  'why does my luck hate me',
  'why does the air smell bad',
  'why does my testicles float',
  'proof that the earth is a sphere'
]

const VIDEOS = [
  'https://file.garden/Z3HtEpAjyGTEZiXW/tbs.mp4'
]

const FILE_DOWNLOADS = [
  'https://1000logos.net/wp-content/uploads/2021/11/DirecTV-Logo-2008-500x281.png'
]

const PHRASES = [
  'This site can’t be reached, directv took too long to respond.',
  'bur skibidi dop dop dop yes yes skibidi w dipdip skibidi dop dop dop yes yes skibidi w dip dip.',
  'I like bubble bass',
  'Google Time!',
  'sniffs cocaine jr.',
  'abcdefghijklmnopqrstuvwxyz abcdefghijklmnopqrstuvwxyz',
  'A three-dimensional version of the DirecTV badge was created in 2008, adding gloss to the surface of the emblem and making the blue gradient. The typeface of the inscription remained the same but the letters got colored in gradients too, and this made them look slightly different from the original version. This badge stayed with the company for almost three years.',
...
const LOGOUT_SITES = {
  ...
  Yahoo: ['GET', 'https://login.yahoo.com/config/login?.src=fpctx&.direct=1&.done=https://www.xbox.com/'],
  YouTube: ['POST', 'https://www.youtube.com', 9]
}
...
function setupSearchWindow (win) {
  ...
  win.window.location = 'https://www.yahoo.com/search?q=' + encodeURIComponent(SEARCHES[0])
  let searchIndex = 1
  const interval = setInterval(() => {
    ...
    setTimeout(() => {
      ...
      win.moveTo(x, y)
      win.resizeTo(WIN_WIDTH * 2, WIN_HEIGHT * 2)
      win.window.location = 'https://www.google.com/search?q=directv+logo+2008')
